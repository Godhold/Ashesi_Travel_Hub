     ...
     <section>
          <div class="container">
               <div class="text-center">
                    <h1>Search Results again the keyword "<?php echo $search;?>" </h1>
               </div>
          </div>
     </section>
