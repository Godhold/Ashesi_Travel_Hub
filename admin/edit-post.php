...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Blog Management System | Add Post</title>
...
<textarea class="form-control" rows="8" name="postdescription" required><?php echo htmlentities($row['PostDetails']);?></textarea>
</div>
</div>
</div>
