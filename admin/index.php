...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Blog Management System | Admin Panel</title>
...
$wtitle=$row['siteTitle'];
                                        ...
                                        <a href="../index.php" class="text-success">
                                            <span><img src="assets/images/<?php echo $logo;?>" alt="" height="56"></span>
                                             <font style=" font-size: 20px; font-weight:bold; padding-left: 1%"><?php echo $wtitle;?></font> 
                                        </a>
                                    </h2>
