...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Blog Management System | Contact us Page</title>
...
<textarea class="form-control" name="pagedescription" rows="8" required><?php echo htmlentities($row['Description'])?></textarea>
</div>
</div>
</div>
<?php } ?>
